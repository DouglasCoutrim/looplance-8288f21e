    ...
    <AppShell title="Gestão Global · Infraestrutura">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Configurações de retenção de replays.</p>
        </div>
      </div>

      <Tabs defaultValue="retencao" className="w-full">
        <TabsList className="mb-4 flex flex-wrap">
          <TabsTrigger value="retencao"><Clock className="mr-2 h-4 w-4" />Limpeza de Vídeos</TabsTrigger>
        </TabsList>
